            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo APP.'/admin/'.$Config['btn'].'/'.$Listing['id'];?>" class="fw-semibold text-current fs-sm d-inline-block">
                        <span class="px-1 me-3 rounded" style="background-color: <?php echo $Listing['color'];?>"></span>
                ...
                <td class="text-end">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm border-0 shadow py-3">
                            ...
                            <a href="<?php echo APP.'/admin/delete/collections/'.$Listing['id'];?>" class="dropdown-item confirm">
